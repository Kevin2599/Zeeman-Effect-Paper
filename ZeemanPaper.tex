...
\section{Introduction} \label{sec:Intro}
	...
	\subsection{Theoretical Overview} \label{sec:Theory}
		...
		\begin{figure*}
			\centering
			\includegraphics[width=1.0\textwidth]{Images/MercuryEnergyLevelsdiagram.png}
			\caption{Energy level transitions of mercury between quantum states. For the purposes of our observations, we are interested in the $7^3S_1 \rightarrow 6^3P_2$ transition which produces 546.1 nm light.}
...
\section{Data and Results} \label{sec:DataAndResults}
	...
	\subsection{Spectra Through a Perpendicular Magnetic Field}
		...
		\subsubsection{Spectra with Field-Perpendicular Polarization}
			...
			\begin{figure}
				\centering
				\includegraphics[width=0.5\textwidth]{Images/Triplet90deg}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.5\textwidth]{Images/Run2_0Deg}
			\caption{}
			\label{fig:Run2_0Deg}
		\end{figure}
